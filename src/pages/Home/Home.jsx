  ...
  return (
    <div className="box-container">
      ...
      <div className="cards-container">
        ...
        <CardInformacoes titulo={"Tarefas Ativas"} icone={<CheckCircleIcon style={{ color: "#E6B648"}}/>} descricao={"x concluídas hoje"} numero={"00"} />
        <CardInformacoes titulo={"Reports Pendentes"} icone={<ErrorIcon style={{ color: "#E6B648"}}/>} descricao={"x adicionado hoje"} numero={"00"} />
